...
- **Doesn't unify.** At design time, `applies_to` was declarative-only;
  ...
  behaviour verified at `561556fd0275`). Programmatic (built-in Rust) checks still have no
