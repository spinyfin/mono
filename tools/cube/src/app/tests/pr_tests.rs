...
fn ensure_pr_uses_body_file_flag_not_body_flag() {
    ...
    let runner = FakeRunner::new(vec![
        ...
        ExpectedCommand::ok(
            cwd.clone(),
            "gh",
            &["api", "repos/spinyfin/mono/pulls?head=spinyfin:my-feature&state=open"],
            "[]",
        ),
...
fn ensure_pr_exists_json_has_action_url_number() {
    ...
    let runner = FakeRunner::new(vec![
        ...
        ExpectedCommand::ok(
            ...
            "gh",
            &["api", "repos/spinyfin/mono/pulls?head=spinyfin:my-feature&state=open"],
            r#"[{"html_url":"https://github.com/spinyfin/mono/pull/7"}]"#,
        ),
...
fn ensure_pr_sets_pr_bookmark_on_existing_pr() {
    ...
    let runner = FakeRunner::new(vec![
        ...
        ExpectedCommand::ok(
            ...
            "gh",
            &["api", "repos/spinyfin/mono/pulls?head=spinyfin:my-feature&state=open"],
            r#"[{"html_url":"https://github.com/spinyfin/mono/pull/33"}]"#,
        ),
...
fn ensure_pr_errors_on_multiple_open_prs() {
    ...
    let runner = FakeRunner::new(vec![
        ...
        ExpectedCommand::ok(
            ...
            "gh",
            &["api", "repos/spinyfin/mono/pulls?head=spinyfin:my-feature&state=open"],
            r#"[{"html_url":"https://github.com/spinyfin/mono/pull/10"},{"html_url":"https://github.com/spinyfin/mono/pull/11"}]"#,
        ),
    ]);
