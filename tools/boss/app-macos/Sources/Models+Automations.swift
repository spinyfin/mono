...
// ===========================================================================
// Automation models. Swift mirrors of `boss_protocol::Automation` and
// `boss_protocol::AutomationRun` — standing instructions that periodically ask
// whether a concrete maintenance task exists and, if so, spawn one via a triage
// agent. Also holds the app's top-level `NavigationMode` and the schedule-picker
// vocabulary backing the Automations pane. Split out of Models.swift to keep
