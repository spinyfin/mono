...
// ===========================================================================
// Product, project, and external-tracker models. Swift mirrors of
// `boss_protocol::Product` and `boss_protocol::Project`, the
// `WorkItemExternalRef` upstream pointer, and the project design-doc resolution
// types. Split out of Models.swift to keep that file under the repo's
// file-size check.
// ===========================================================================
