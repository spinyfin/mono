...
// ===========================================================================
// Core work-item models. `WorkTask` is the app's mirror of
// `boss_protocol::WorkItem` — the task/chore/project/design row every other
// surface hangs off — together with its derived badges, priority and node-id
// vocabulary, runtime state, and dependency rows.
//
// Related models live in sibling files, split out to keep this one under the
