...
// ===========================================================================
// Transcript rendering (design: tools/boss/docs/designs/transcript-viewer.md,
// impl task 4). View models for one rendered agent transcript — the segment
// stream, its truncation metadata, and the load state the viewer drives from.
// Split out of Models.swift to keep that file under the repo's file-size check.
// ===========================================================================
