...
// ===========================================================================
// Editorial controls (design: tools/boss/docs/designs/
// editorial-controls-for-agent-authored-prs-and-github-comments.md). Swift
// mirrors of `boss_protocol::EditorialRules` and friends — the per-product rules
// constraining what workers write into GitHub-visible surfaces, plus the
// `EditorialAction` audit row the enforcement hook records. Split out of
