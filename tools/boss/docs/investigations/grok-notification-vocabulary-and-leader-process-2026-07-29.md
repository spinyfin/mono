...
- **Version under test:** `grok 0.2.114 (0c785038798)` — **newer than the driver's `PINNED_GROK_VERSION` (`0.2.112`)**, see [Version drift](#version-drift-the-driver-would-currently-refuse-to-provision)
- **Host:** macOS aarch64
