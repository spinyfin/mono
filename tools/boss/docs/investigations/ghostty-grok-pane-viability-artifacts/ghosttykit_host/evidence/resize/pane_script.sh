...
print -r -- "scenario=resize" > "/private/tmp/grok-pane-spike/ghosttykit_host/run_out/scenario.txt"
print -r -- "sid=dccaef32-3fac-4808-ab88-b2f739707705" >> "/private/tmp/grok-pane-spike/ghosttykit_host/run_out/scenario.txt"
...
"/Users/brianduff/.grok/bin/grok" --no-alt-screen --always-approve --trust --session-id "dccaef32-3fac-4808-ab88-b2f739707705" --cwd "/tmp/grok-pane-spike/cwd"   "reply with exactly the single token: gkit-grok-ok. do not use tools. Then wait for further instructions."
