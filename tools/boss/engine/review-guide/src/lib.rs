...
pub const PROMPT_VERSION: &str = "review-guide-v4";
...
pub const PROMPT_TEMPLATE_SHA256: &str = "2e250cf69d80036e8333243a4abdc3d4c8abee907a4671dacb1fb1d436883481";
...
mod tests {
    ...
    fn prompt_uses_only_supplied_context_without_inviting_exploration() {
        assert_eq!(PROMPT_VERSION, "review-guide-v4");
