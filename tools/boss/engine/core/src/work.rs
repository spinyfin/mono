...
pub use boss_protocol::{
    ...
    Automation, AutomationPatch, AutomationRun, AutomationTrigger, BOOTHBY_FINDING_STATUS_SUPPRESSED,
    BOOTHBY_REVERSIBILITY_IRREVERSIBLE, BOOTHBY_TARGET_ATTENTION, BOOTHBY_TARGET_ATTENTION_ITEM,
    BOOTHBY_TARGET_PROJECT, BOOTHBY_TARGET_TASK, BlockedSignal, BoothbyActInput, BoothbyActOutcome, BoothbyAction,
