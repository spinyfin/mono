...
pub async fn serve_with_merge_probe(
    ...
    *server_state
    ...
    // classified from driver-originated semantic progress (last event time
    ...
    let _transient_recovery_handle = crate::transient_recovery::spawn_loop(
        ...
        server_state.execution_coordinator.clone(),
        server_state.dispatch_events.clone(),
        crate::transient_recovery::RecoveryWorkers {
            nudger: Arc::clone(&server_state) as Arc<dyn crate::transient_recovery::WorkerNudger>,
            reaper: Arc::clone(&server_state) as Arc<dyn crate::transient_recovery::TransientRecoveryReaper>,
        },
