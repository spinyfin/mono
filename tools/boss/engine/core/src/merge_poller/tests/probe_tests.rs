...
fn parse_probe_covers_state_mergeable_status_matrix() {
    ...
    let cases = [
        ...
        Case {
            label: "CONFLICTING is Conflict even when mergeStateStatus has not reached DIRTY",
            state: "OPEN",
            merged_at: "",
            mergeable: "CONFLICTING",
        ...
        Case {
            label: "CONFLICTING + BLOCKED is still a conflict (branch protection coexists)",
            state: "OPEN",
            merged_at: "",
            mergeable: "CONFLICTING",
