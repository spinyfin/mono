//! Reviewer prompt and markdown rendering: the reviewer's initial-prompt,
//! CLAUDE.md, revision instructions, and the rubric/tripwire sub-sections.

use super::result::{ReviewFindingCategory, ReviewFindingConfidence, ReviewFindingSeverity, ReviewResult};
use super::scope::{PrReviewContext, ReviewScope};
