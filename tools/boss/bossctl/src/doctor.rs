...
/// a blocked local dispatcher without first starting the app. File-scan /
/// process probe only — no engine RPC — so this still answers when the
/// engine is wedged or not running.
