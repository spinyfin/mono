...
pub struct Task {
    ...
    /// Starting a non-review execution or advancing into Review clears these
    /// states; starting a `pr_review` execution preserves them. On in_review
    /// rows this is the state of required-review gating at last poll. Values:
